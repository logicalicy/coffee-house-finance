(function() { this.JST || (this.JST = {}); this.JST["templates/portfolios/portfolio-template"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<td>',  name ,'</td>\n<td>',  value ,'</td>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["templates/portfolios/portfolios-template"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<thead>\n<tr class="header">\n  <th>Name</th>\n  <th>Value</th>\n</tr>\n</thead>\n<tbody>\n</tbody>\n');}return __p.join('');};
}).call(this);
/*!
...
var portfolioTpl = JST['templates/portfolios/portfolio-template'],
    portfoliosTpl = JST['templates/portfolios/portfolios-template'];

// Create our Application
var Portfolio, PortfolioView, Portfolios, PortfoliosView, App, portfolios;
...
PortfoliosView = Backbone.Marionette.CompositeView.extend({
  tagName: "table",
  id: "portfolios",
...
App.addInitializer(function(options) {
  var portfoliosView;
  portfoliosView = new PortfoliosView({
    collection: options.portfolios
  });
  return App.mainRegion.show(portfoliosView);
});
